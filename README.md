...
* 1 Prepare your data. Make directories *data* and *export*. The data directory should look like,
    ...
    ```
* 2 The training steps are much similar to [rpautrat/Superpoint](https://github.com/rpautrat/SuperPoint). However you'd better to read the scrips first so that you can give correct settings for your envs.   
    - 2.1 Train MagicPoint: `python train.py ./config/magic_point_train.yaml`   
    （Note that you have to delete the directory _./data/synthetic_shapes_ whenever you want to re-generate the synthetic data set）
